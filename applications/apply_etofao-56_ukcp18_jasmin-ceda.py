...
sys.path.append("/home/users/nelerey/phd_code/ETo")
print("sys.path: \n", sys.path)
# import glob
...
et_ukcp18_fao = et_ukcp18_fao.assign_attrs(attributes)
et_ukcp18_fao = et_ukcp18_fao.assign_attrs(input_attributes)
et_ukcp18_fao.name = outvarname
et_ukcp18_fao.to_netcdf(outpath, engine='netcdf4', format='NETCDF4', 
                       encoding = {outvarname: {"dtype": "float32"}})
